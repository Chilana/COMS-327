...
static void move_swimmer_func(character_t *c, pair_t dest)
{
  ...
  dest[dim_x] = static_cast<int16_t>(c->pos[dim_x]);
  dest[dim_y] = static_cast<int16_t>(c->pos[dim_y]);
  ...
  if (is_adjacent((int16_t)world.pc.pos, ter_water) &&
    ...
    dir[dim_x] = static_cast<int16_t>(dir[dim_x]);
    dir[dim_y] = static_cast<int16_t>(dir[dim_y]);
